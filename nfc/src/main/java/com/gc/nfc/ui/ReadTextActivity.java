...
import static com.gc.nfc.ByteArrayToHexHelper.ByteArrayToHexString;
import static com.gc.nfc.ByteArrayToHexHelper.flipHexStr;
...
public class ReadTextActivity extends BaseNfcActivity {
    ...
    public void onNewIntent(Intent intent) {
        ...
        String numText = cardNo.toString();
        Toast.makeText(getApplicationContext(), numText, Toast.LENGTH_SHORT).show();
        mNfcText.setText(numText);
